...
#define BUZZER_S00_AXI_SLV_REG1_OFFSET 4
#define BUZZER_S00_AXI_SLV_REG2_OFFSET 8
#define BUZZER_S00_AXI_SLV_REG3_OFFSET 12
 ...
 *
 * @param   BaseAddress is the base address of the BUZZERdevice.
 ...
 * @note
 * C-style signature:
 * 	void BUZZER_mWriteReg(u32 BaseAddress, unsigned RegOffset, u32 Data)
 *
 */
 ...
 * @note
 * C-style signature:
 * 	u32 BUZZER_mReadReg(u32 BaseAddress, unsigned RegOffset)
 *
 */
 ...
 *
 */
XStatus BUZZER_Reg_SelfTest(void * baseaddr_p);
